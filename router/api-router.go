...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		tokenRoute.Use(middleware.TokenOperationAudit())
		{
			...
			tokenRoute.POST("/regenerate", middleware.CriticalRateLimit(), middleware.UserCriticalRateLimit("api-key"), middleware.DisableCache(), controller.RegenerateUserAPIKey)
